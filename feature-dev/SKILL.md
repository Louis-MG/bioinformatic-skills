---
name: feature-dev
description: Use when the user wants a guided feature development workflow. Invoke with /feature-dev followed by a description of the feature you want to build. Runs 7 structured phases: Discovery, Codebase Exploration, Clarifying Questions, Architecture Design, Implementation, Quality Review, and Summary. Delegates exploration, design, and review work to specialised subagents.
license: MIT
author: Gareth Hallberg
version: 1.0
user-invocable: true
allowed-tools:
  - read_file
